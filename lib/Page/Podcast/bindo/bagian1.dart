...
class BindoBagian1 extends StatefulWidget {
  const BindoBagian1({Key? key}) : super(key: key);

  @override
  _BindoBagian1State createState() => _BindoBagian1State();
}

class _BindoBagian1State extends State<BindoBagian1> {
