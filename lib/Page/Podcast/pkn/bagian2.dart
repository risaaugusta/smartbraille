...
class Bagian2 extends StatefulWidget {
  const Bagian2({Key? key}) : super(key: key);

  @override
  _Bagian2State createState() => _Bagian2State();
}

class _Bagian2State extends State<Bagian2> {
